...
from bokeh.models import ColumnDataSource, Range1d, Title, Label, TapTool, OpenURL
...
def create_scatter_plot(data):
    ...
    project_ids = data["project_ids"]  # Assuming you have a 'project_ids' list that uniquely identifies each project

    # Include 'project_id' in the ColumnDataSource
    ...
    p = figure(
        ...
        match_aspect=False,
        tools="hover,tap",  # Added "tap" tool here
