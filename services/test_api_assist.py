...
class IdeaGenerator:
    ...
    def start_chat(self):
        ...
        print("Aloitetaan Business Model Canvas -luonti. Kuvaile ideasi mahdollisimman kattavasti.")
        user_message = input("Sinä: ")
        conversation = [
            {"role": "system", "content": "We are working on a Business Model Canvas (BMC). Guide the user by asking relevant questions to complete the BMC. Let the user also ask unrelated questions."},
        ...
        while True:
            ...
            if user_input.lower() in ["lopeta", "valmis"]:
                print("\nBMC-luonti päättyi.")
                break
...
if __name__ == "__main__":
    ...
    start = input("Haluatko luoda uuden idean? (kyllä/ei): ")
    if start.lower() != "kyllä":
        print("Ohjelma päättyy.")
    else:
        generator.create_thread()
        generator.start_chat()
        print("\nLopullinen Business Model Canvas tallennettu.")
